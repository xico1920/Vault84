    ...
    return {
            ...
            <div class="dept-layout">
              <div class="dept-main">
                ...
                <div class="panel">
                  ...
                  <p class="label" style="margin-bottom:0.75rem;">Game state is session-only. Refresh resets all progress.</p>
                  <button id="set-clear" class="btn btn-danger" style="padding:7px 20px;letter-spacing:2px;">CLEAR OVERSEER DATA</button>
                </div>
        ...
        async onRendered() {
            ...
            document.getElementById('set-clear')?.addEventListener('click',()=>{
                if(confirm('Clear Overseer data and restart?')){
                    localStorage.removeItem(USERNAME_KEY);
                    localStorage.removeItem('vault84_tutorial_seen');
                    location.reload();
                }
            });
