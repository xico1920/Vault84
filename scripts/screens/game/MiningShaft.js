...
export function createMiningShaftScreen() {
    let viewer3d = null, tickFn = null, cooldown = false;
    ...
    function upd() {
        ...
        const btn=$('ms-mine'); if(btn){const ok=!cooldown&&r.efficiency>0;btn.disabled=!ok;btn.style.opacity=ok?'1':'0.35';}
    }
            ...
            <div class="dept-layout">
              <div class="dept-main">
                ...
                <div class="panel">
                  ...
                  <button id="ms-mine" class="btn btn-primary" style="width:100%;max-width:240px;padding:10px;font-size:1.6rem;letter-spacing:4px;">
                    [ MINE ]
                  </button>
